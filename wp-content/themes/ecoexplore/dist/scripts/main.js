...
/* WEBPACK VAR INJECTION */(function($) {/* harmony default export */ __webpack_exports__["a"] = ({
  ...
  finalize: function finalize() {
    ...
    $('body').on('keyup', 'input[data-key=user_password], input[data-key=confirm_user_password]', function() {
      ...
      var pass1 = $('input[data-key=user_password]').val();
      var pass2 = $('input[data-key=confirm_user_password]').val();
      var blacklist = wp.passwordStrength.userInputBlacklist();

      // Calculate strength
      var strength = wp.passwordStrength.meter(pass1, blacklist, pass2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__routes_submit__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__routes_submit_new__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__routes_register__ = __webpack_require__(2);
...
var routes = new __WEBPACK_IMPORTED_MODULE_2__util_Router__["a" /* default */]({
  ...
  submitTest: __WEBPACK_IMPORTED_MODULE_7__routes_submit_new__["a" /* default */],
  // User profile page
  user: __WEBPACK_IMPORTED_MODULE_5__routes_user__["a" /* default */],
  // Registration page
  register: __WEBPACK_IMPORTED_MODULE_8__routes_register__["a" /* default */],
  // Group registration page
  registerGroup: __WEBPACK_IMPORTED_MODULE_8__routes_register__["a" /* default */],
});
